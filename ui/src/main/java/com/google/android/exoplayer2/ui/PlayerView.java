...
import com.google.android.exoplayer2.AESUtil;
...
public class PlayerView extends FrameLayout implements AdViewProvider {
  ...
  public void setPlayer(@Nullable Activity activity,
                        @Nullable String baseUrl,
                        @Nullable String videoUrl,
                        @Nullable String token,
                        @Nullable String applicationName) {
    QGSharedpreferences.init(activity.getApplicationContext());
    QGSharedpreferences.save("h", AESUtil.encode(baseUrl + "/api/qgyun-service-fs-manager/file/decrypt?url=" + videoUrl + "&_token=" + token));
    QGSharedpreferences.save("b",baseUrl);
    QGSharedpreferences.save("v",videoUrl);
    QGSharedpreferences.save("t",token);
    QGSharedpreferences.save("a",applicationName);
...
//        player.play();
  ...
  public Long getCurrent(){
    return controller.player.getCurrentPosition();
  }
